...
type PhMaxActionCalcYmBrick struct {
	bk *bmpipe.BMBrick
}
...
func (b *PhMaxActionCalcYmBrick) Exec() error {
	...
	confMap := calcYmConf.Conf.(map[string]interface{})
	...
	confMap["cpa_file"] = cpaDesName
	confMap["gycx_file"] = gycDesName
	confMap["not_arrival_hosp_file"] = notArrivalHospDesName
...
func (b *PhMaxActionCalcYmBrick) Prepare(pr interface{}) error {
	req := pr.(max.PhAction)
...
func (b *PhMaxActionCalcYmBrick) Done(pkg string, idx int64, e error) error {
...
func (b *PhMaxActionCalcYmBrick) BrickInstance() *bmpipe.BMBrick {
	if b.bk == nil {
		b.bk = &bmpipe.BMBrick{}
	}
	return b.bk
...
func (b *PhMaxActionCalcYmBrick) ResultTo(w io.Writer) error {
...
func (b *PhMaxActionCalcYmBrick) Return(w http.ResponseWriter) {
